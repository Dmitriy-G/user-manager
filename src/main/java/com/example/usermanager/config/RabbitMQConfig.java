...
import com.example.usermanager.externallayers.ChangeCustomerStatusReceiver;
...
public class RabbitMQConfig {
    ...
    @Bean
    MessageListenerAdapter listenerAdapter(ChangeCustomerStatusReceiver receiver) {
